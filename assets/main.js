...
fetch('http://api.openweathermap.org/data/2.5/weather?id=3081368&lang=en&appid=c43016557ce6a48d27caa09c7ba1557e')
    ...
    .then(function (data) {
        ...
        document.querySelector('.weather__temp').innerHTML = 'Temp:' + Math.round(data.main.temp - 273) + '&deg;C';
        document.querySelector('.weather__humidity').innerHTML = `Humidity: ${data.main.humidity}%`;
        document.querySelector('.weather__wind').innerHTML = `Wind: ${data.wind.speed} km/h`;
